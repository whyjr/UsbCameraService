...
public class GLProgram {
    ...
    public void buildTextures(Buffer y, Buffer u, Buffer v, int width, int height) {
        ...
        if (videoSizeChanged) {
            ...
            Log.e(TAG, "buildTextures videoSizeChanged: w=" + _video_width + " h=" + _video_height);
        }

        //Log.e(TAG, "buildTextures 1");
        // building texture for Y data
        if (_ytid < 0 || videoSizeChanged) {
            if (_ytid >= 0) {
                Log.e(TAG, "glDeleteTextures Y");
            ...
            _ytid = textures[0];
            Log.e(TAG, "glGenTextures Y = " + _ytid);
        }
...
//                GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, y);
        ...
        if (_utid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _utid = textures[0];
            Log.e(TAG, "glGenTextures U = " + _utid);
        }
...
//                GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, u);
        ...
        if (_vtid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _vtid = textures[0];
            Log.e(TAG, "glGenTextures V = " + _vtid);
        }
...
//                GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, v);
     ...
     */
    public void drawFrame(Buffer y, Buffer u, Buffer v) {
    ...
    public int createProgram(String vertexSource, String fragmentSource) {
        ...
        Log.e(TAG, "pixelShader = " + pixelShader);
